...
1. Ramsar Sites Information Service, `Complejo Los Cobanos`
   URL: https://rsis.ramsar.org/es/ris/2419
   Notes:
...
2. Ministerio de Medio Ambiente y Recursos Naturales, `Cuarto Informe Nacional CBD El Salvador`
   ...
   Notes:
   - Describes Los Cóbanos as volcanic rocky reef habitat with reef-building corals such as `Porites lobata` and `Pocillopora spp`.
   - Mentions vertebrates and fishes in the zone including `Paranthias colonus`, `Scarus perrico`, `Zanclus cornutus`, and humpback whales in the dry season.

3. Visit El Salvador, `Buceo y Snorkel en El Salvador: Guía de los Mejores Sitios`
   URL: https://www.visitelsalvador.ai/blog/plongee-snorkeling-salvador-guide-complet?lang=es
   Notes:
   - Useful for visitor-facing snorkeling guidance.
   - Supports practical notes about Los Cóbanos entry points, low tide, biodegradable sunscreen, water shoes, and the common Nov-Apr recommendation for better visibility.

4. Ministerio de Medio Ambiente y Recursos Naturales, `MARN lanza proyecto Viva Ballena`
   URL: https://www.marn.gob.sv/marn-lanza-proyecto-viva-ballena/
   Notes:
   - Useful for current official context on whale-watching activity and licensed operators in El Salvador.
   - Better fit than a travel video when linking visitors to more information.

5. Whale and Dolphin Conservation, `Empowering communities through responsible whale watching`
   URL: https://us.whales.org/2024/04/09/empowering-communities-through-responsible-whale-watching/
   Notes:
   - Supports cautious whale-watching language for El Salvador and Los Cóbanos.
   - Reinforces responsible viewing and the presence of dolphins in the protected area.

6. iNaturalist observation views centered on Victor's meeting point
   URLs:
   - https://www.inaturalist.org/observations?lat=13.5254549&lng=-89.8061826&radius=8&subview=map
   - https://www.inaturalist.org/observations?lat=13.5254549&lng=-89.8061826&radius=8&iconic_taxa=Actinopterygii&subview=map
   - https://www.inaturalist.org/observations?lat=13.5254549&lng=-89.8061826&radius=3&iconic_taxa=Reptilia&subview=map
   Notes:
